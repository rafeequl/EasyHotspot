...
<html>
<head>
  <title>EasyHotspot Login Failed</title>
...
if ($result == 5) {
    print "
  <h1 style=\"text-align: center;\">EasyHotspot Login</h1>";
}
...
if ($result == 1) {
  print "
  <h1 style=\"text-align: center;\">Logged in to EasyHotspot</h1>";
...
if (($result == 3) || ($result == 13)) {
    print "
  <h1 style=\"text-align: center;\">Logged out from EasyHotspot</h1>
  <center>
